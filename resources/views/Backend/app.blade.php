      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ Route::getCurrentRoute()->getName() == 'Backend.home' ? 'active' : ''  }}">
            ...
            <li class="menu-item {{ Route::getCurrentRoute()->getName() == 'Backend.about' ? 'active' : ''  }}">
              <a href="{{ route('Backend.about') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="About">About</div>
              </a>
            </li>

            <li class="menu-item {{ Route::getCurrentRoute()->getName() == 'Backend.contact' ? 'active' : ''  }}">
              <a href="{{ route('Backend.contact') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-crown"></i>
