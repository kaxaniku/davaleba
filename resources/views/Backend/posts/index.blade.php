            ...
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header">
                        <a type="button" class="btn btn-primary" href="{{ route('Backend.posts.create') }}">Add Post</a>
                    </h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('Backend.posts.edit', ['id' => $item->id]) }}">
                                                    <i class="bx bx-edit-alt me-1"></i> Edit
                                                </a>
                                                <a class="dropdown-item" href="{{ route('Backend.posts.destroy', ['id' => $item->id]) }}">
